...
const ToolViewPage = () => {
    ...
    return (
        <div className='flex flex-col gap-6'>
            ...
            <div className='gap-6 flex flex-col bg-primary-bg px-6 py-15 rounded-3xl'>
                ...
                <div className='flex flex-col'>
                    <h4 className='w-max text-sm font-bold text-primary-color bg-group-bg rounded-tl-xl rounded-tr-xl px-4 py-1'>Author</h4>
                    ...
                    <div className='flex items-center gap-3 bg-group-bg rounded-bl-xl rounded-br-xl rounded-tr-xl px-4 py-2'>
                        ...
                        <div className='flex items-center gap-1 text-primary-color text-xs'>
                        ...
                        <div className='flex items-center gap-1 text-primary-color text-xs ml-auto'>
