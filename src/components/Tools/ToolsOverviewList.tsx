...
const ToolsOverviewList = ({ tools = [], toolsLabel = "" }: { tools: Tool[], toolsLabel: string }) => {
    return (
        <div className='w-full grid grid-rows-7 sm:[&>*:nth-child(2)]:border-t'>
            <h4 className='w-min lg:w-max h-min px-4 text-wrap lg:px-4 lg:text-[14px] 2xl:text-[16px] justify-self-center sm:justify-self-start
