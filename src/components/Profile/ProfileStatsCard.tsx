...
const ProfileStatsCard = ({ label, value, iconName }: ProfileStatsCardProps) => {
    return (
        <div className='w-full flex items-center gap-6 xl:gap-4 bg-primary-bg dark:bg-group-bg sm:dark:bg-primary-bg p-6 2xl:p-8 rounded-xl'>
...
const icon = {
    "tool": <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-tools" viewBox="0 0 16 16">
    ...
    "vote": <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-archive-fill" viewBox="0 0 16 16">
                <path d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15zM5.5 7h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1M.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8z"/>
            </svg>,
    "bookmark": <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-bookmark" viewBox="0 0 16 16">
